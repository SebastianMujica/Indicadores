...
public  class Unidad_Org extends DtoBase {
  ...
  @Index(name="idx_codigo_unidad_org") 
  @NotNull() @Size(min=3,max=20,message="{longitud_entre}") String strcodigo;
  
  @Index(name="idx_org_superior_unidad_org")
  @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
  @JoinColumn(name="lngsis_unidad_org_superior",insertable=true,updatable=true,nullable=true) 
  @ManyToOne(fetch=FetchType.EAGER) 
  @LazyCollection(LazyCollectionOption.FALSE) Unidad_Org dto_unidad_org_superior;
  ...
  public Unidad_Org getDto_unidad_org_superior(){
    return dto_unidad_org_superior;
  }
  public void setDto_unidad_org_superior(  Unidad_Org param){
    this.dto_unidad_org_superior=param;
  }
