...
public class vistaUnidad_Org extends VistaBase {
  ...
  JLabel lbldto_unidad_org_superior=new JLabel("Depende de: ");
  ComboBox cmbdto_unidad_org_superior=new ComboBox(new Unidad_Org());
  ...
  public vistaUnidad_Org(  ActionListener controlador){
    this.setTitle("Unidades Organizacionales");
    ...
    this.cmbdto_unidad_org_superior.addActionListener(controlador);
    this.agregar(lbldto_unidad_org_superior,cmbdto_unidad_org_superior,"","width 250px,wrap 1");
  ...
  public JLabel getLbldto_unidad_org_superior(){
    return lbldto_unidad_org_superior;
  }
  public void setLbldto_unidad_org_superior(  JLabel param){
    this.lbldto_unidad_org_superior=param;
  }
  public ComboBox getCmbdto_unidad_org_superior(){
    return cmbdto_unidad_org_superior;
  }
  public void setCmbdto_unidad_org_superior(  ComboBox param){
    this.cmbdto_unidad_org_superior=param;
  }
