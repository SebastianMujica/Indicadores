...
public class vistaPais extends VistaBase {
  ...
  JTextField txtstrsigla=new JTextField(3);
  JLabel lblestados=new JLabel("Estados: ");
  ListaDoble lstestados=new ListaDoble("estados",new Estado());
  ...
  public vistaPais(  ActionListener controlador){
    this.setTitle("Pais");
    ...
    this.agregar(lblestados,lstestados,"","width 250px,wrap 1");
  ...
  public void setLblestados(  JLabel param){
    this.lblestados=param;
  }
  public ListaDoble getLstestados(){
    return lstestados;
  }
  public void setLstestados(  ListaDoble param){
    this.lstestados=param;
  }
