...
public class vistaEstado extends VistaBase {
  JLabel lbllngid=new JLabel("Lngid: ");
  JTextField txtlngid=new JTextField(15);
  JLabel lbldtopais=new JLabel("País: ");
  ...
  ListaDoble lstmunicipios=new ListaDoble("municipios",new Municipio());
  ...
  public vistaEstado(  ActionListener controlador){
    ...
    this.agregar(lbldtopais,cmbdtopais,"","width 250px,wrap 1");
    ...
    this.agregar(lblstrsigla,txtstrsigla,"","width 100px,wrap 1");
    
    this.agregar(lblmunicipios,lstmunicipios,"","width 250px,wrap 1");
  ...
  public JLabel getLblmunicipios(){
    return lblmunicipios;
  }
  public void setLblmunicipios(  JLabel param){
    this.lblmunicipios=param;
  }
  public ListaDoble getLstmunicipios(){
    return lstmunicipios;
  }
  public void setLstmunicipios(  ListaDoble param){
    this.lstmunicipios=param;
  }
