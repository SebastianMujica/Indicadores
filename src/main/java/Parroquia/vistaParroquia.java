...
public class vistaParroquia extends VistaBase {
  ...
  public vistaParroquia(  ActionListener controlador){
    this.setTitle("Parroquia");
    ...
    this.agregar(lbldtomunicipio,cmbdtomunicipio,"","width 250px,wrap 1");
    ...
    this.agregar(lblstrsigla,txtstrsigla,"","width 180px,wrap 1");
