...
public abstract class AbstractDAO
{
    ...
    public static <T> T getEntidad(String clave, Class<T> claseEntidad) throws HibernateException
    {
        AbstractDAO dummy = new AbstractDAO(){};
        ...
        {
            dummy.iniciaOperacion();
            Criteria criterio = dummy.getSession().createCriteria(claseEntidad);
    	    Criterion fk = Restrictions.ilike("nombre",clave+"%");
    	    criterio.add(fk);
    	    objetoRecuperado = (T) criterio.uniqueResult();
        }
        catch (HibernateException he)
        {
            dummy.manejaExcepcion(he);
