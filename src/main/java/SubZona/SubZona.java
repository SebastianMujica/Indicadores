...
public  class SubZona extends DtoBase {
  ...
  @Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
  @Index(name="idx_zona_subzona") 
  @JoinColumn(name="zona_lngid",insertable=true,updatable=false,nullable=false) 
  @ManyToOne(fetch=FetchType.EAGER) 
  @LazyCollection(LazyCollectionOption.FALSE) Zona dtozona;
  ...
  public void setDtozona(  Zona param){
    this.dtozona=param;
  }
